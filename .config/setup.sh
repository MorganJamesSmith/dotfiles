...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to Morgan's configuration Script!\\n\\nThis script will automatically install a fully-featured dwm Void Linux desktop, which I use as my main machine.\\n\\n-Morgan" 10 60
	}

getuser() { \
	name=$(dialog --inputbox "First, please enter a name for the user account for which you'd like to configure." 10 60 3>&1 1>&2 2>&3 3>&1) || exit
